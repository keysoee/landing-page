...
export function AnimatedAIChat() {
  ...
  }, [value, commandSuggestions]); // Tambahkan commandSuggestions ke dependency array
          ...
          >
            ...
            <div className="p-4">
              <Textarea
                ref={textareaRef}
                value={value}
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => { // Perbaikan di sini
...
// Pastikan kode ini hanya dijalankan di lingkungan browser (client-side)
